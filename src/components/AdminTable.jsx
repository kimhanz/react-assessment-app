                ...
                <>
                  ...
                  <td className="border p-2 ">
                    ...
                    <button
                      ...
                      className="cursor-pointer bg-gray-400 hover:bg-gray-500 text-white px-2 rounded-xl mx-0.5"
                    >
                      Cancel
                    </button>
                  </td>
                ...
                <>
                  ...
                  <td className="border p-2 ">
                    <button
                      ...
                      className="cursor-pointer bg-yellow-400 hover:bg-yellow-500 text-white px-2 rounded-xl mx-0.5"
                    >
                      Edit
                    </button>
                    <button
